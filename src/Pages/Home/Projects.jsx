...
const Projects = () => {
  return (
    <div className="px-20">
      ...
      <div className="grid grid-cols-1 py-4 lg:grid-cols-3 lg:pb-16 gap-5">
        <div className=" shadow-md shadow-gray-600 rounded-md">
          ...
          <div className="text-white grid  gap-2 py-5 px-2">
            <div>
              <a
                href="https://meal-nest-hub.firebaseapp.com/"
            ...
            <div>
              <p className="text-justify ">
                Restaurant system with a membership system with different
                packages allows users to upgrade for additional benefits. also,
                there is an individual dashboard for user and admin.
              </p>
            </div>
            <div className="  space-x-2  text-sm  mt-2 ">
              ...
              <span className="p-1.5 bg-slate-700 rounded-md">
                Tailwind Css
              </span>
            </div>
          </div>
        ...
        <div className=" shadow-md shadow-gray-600 rounded-md">
          ...
          <div className="text-white grid  gap-2 py-5 px-2">
            <div>
              <a
                href="https://jobs-hub-391a3.web.app/"
                className=" flex gap-3 items-center"
              >
            ...
            <div>
              <p className="text-justify">
                Build this job search website with categorized listings.
                Implemented user-friendly navigation, accessible dashboards for
                job management, and visually rich listings for quick insights.
              </p>
            </div>
        ...
        <div className=" shadow-md shadow-gray-600 rounded-md">
          ...
          <div className="text-white grid  gap-2 py-5 px-2">
            <div>
              <a
                href="https://event-management-11bdc.web.app/"
                className=" flex gap-3 items-center"
              >
            ...
            <p className="text-justify">
              The website features detailed event service information. Clients
              can securely create accounts with email and password
              authentication. The site is responsive across devices, ensuring a
